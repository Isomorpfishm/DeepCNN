...
# model.load_weights('./gdrive/MyDrive/model/model-classification-second-run.h5')
model.save_weights(checkpoint_path.format(epoch=0))

history = model.fit(x_train, y_train, epochs=7, batch_size=70, shuffle=True, validation_split = 0.2, callbacks=[cp_callback])

model.save('./gdrive/MyDrive/model/model-classification.h5')
...
plt.plot([0, 1], [0, 1], 'k--')
plt.plot(fpr_keras, tpr_keras, label='G4NN-modified (area = {:.3f})'.format(auc_keras))
