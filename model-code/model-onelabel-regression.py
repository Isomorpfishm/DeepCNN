...
chromosomes_1 = ['chr2', 'chrX', 'chr21', 'chr7', 'chr15', 'chr17', 'chr19']
chromosomes_2 = ['chr6', 'chr10', 'chrY', 'chr14', 'chr16', 'chr9', 'chr18']
chromosomes_3 = ['chr4', 'chr8', 'chr11', 'chr13', 'chr20', 'chr12', 'chr22']        
...
# model.load_weights('./gdrive/MyDrive/model/model-regression-onelabel-second-run.h5')
...
model.save('./gdrive/MyDrive/model/model-regression-onelabel.h5')
