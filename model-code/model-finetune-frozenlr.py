...
# check the number of trainable/non-trainable params, only the fine-tuning layers should be trainable
model2.summary()
...
history = model2.fit(x_train, y_train, epochs=2, batch_size=70, shuffle=True, validation_split = 0.2)

model2.save('./gdrive/MyDrive/model/model-finetune-frozenlr.h5')
